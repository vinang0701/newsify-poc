...
function NewsPostCard({ news, currentUserId, inst_id }: NewsPostCardProps) {
    ...
    // UPDATED: show full-screen bottom menu instead of card-level bottom sheet
    const handleExpandSheet = () => setMenuVisible(true);
    ...
    const handleSuspend = async () => {
        ...
        try {
            ...
            setMenuVisible(false); // UPDATED: close full-screen bottom menu
    ...
    return (
        <View>
            ...
            {/* UPDATED: Full-screen bottom popup menu */}
            <Modal
                visible={menuVisible}
                transparent={true}
                animationType="slide"
            ...
            >
                ...
                >
                    <Pressable style={styles.fullScreenMenu}>
...
const styles = StyleSheet.create({
    ...
    // UPDATED: full-screen bottom popup menu styles
    fullScreenOverlay: {
        flex: 1,
