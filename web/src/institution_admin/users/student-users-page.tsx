...
const StudentUsersMgmtPage = () => {
    ...
    async function fetchStudentUsers(): Promise<User[]> {
        try {
            const response = await api.get<User[]>(`/${inst_id}/admin/users/students`);
                            ...
                            <form id="create-user-form" onSubmit={form.handleSubmit(onSubmit)}>
                                ...
                                <DialogContent className="py-6 px-8">
                                    <DialogHeader>
                                        ...
                                        <DialogDescription>
                                            Please fill in user account details and click add to create a new account.
                                        </DialogDescription>
                                    </DialogHeader>
                                    <FieldGroup>
                                        <Controller
                                        ...
                                        <Controller
                                            ...
                                            render={({ field, fieldState }) => (
                                                <Field data-invalid={fieldState.invalid} className="flex flex-col items-center">
                                                    <Label htmlFor="password-1" className="w-xs">
                                    ...
                                    <DialogFooter className="bg-transparent border-0">
                                        ...
                                        <Button variant="outline" type="submit" form="create-user-form" className="rounded-sm justify-self-end">
                                            Add
                                        </Button>
                                    </DialogFooter>
                                </DialogContent>
