				...
				<SidebarMenu>
					<SidebarMenuItem className="px-2 gap-2">
						...
						<Collapsible
							defaultOpen={false}
							className="group/collapsible"
							open={pathname.startsWith("/admin/communities")}
						>
							<SidebarGroupLabel
								className="w-full flex gap-2 px-2 text-text font-normal cursor-pointer hover:bg-sidebar-accent text-base font-regular h-10 justify-between"
								asChild
							>
								<Link to={"/admin/communities"}>
									<CollapsibleTrigger className="w-full flex flex-row items-center gap-2 cursor-pointer">
										<Users2 size={16} />
							...
							<CollapsibleContent className="border-l border-border mx-4 px-2">
								<Link to={"/admin/communities/requests"}>
									<SidebarMenuButton>
										Requests
									</SidebarMenuButton>
								</Link>
