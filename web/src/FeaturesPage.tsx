    ...
    return (
        ...
        >
            ...
            <section
                style={{
                    background:
                        "linear-gradient(160deg, #1D4ED8 0%, #2563EB 50%, #3B82F6 100%)",
                    padding: "80px 60px",
                    textAlign: "center",
                }}
            >
                ...
                >
                    Everything you need to stay informed, connected, and engaged
            ...
            >
                ...
                >
                    Join your institution on Newsify today.
                </p>
                <button
                    onClick={() => {
                        sessionStorage.setItem("scrollTo", "contact");
            ...
            >
                <span style={{ color: "#475569", fontSize: 13 }}>
                    © 2026 Newsify. All rights reserved.
                </span>
            </footer>
        </div>
    );
