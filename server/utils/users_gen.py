...
def generate_unique_users(filename, target_count=20):
    unique_users = []
    ...
    while len(unique_users) < target_count:
        ...
        if email not in seen_emails:
            ...
            unique_users.append({"name": full_name, "email": email})
...
if __name__ == "__main__":
    generate_unique_users("unique_sim_users.csv")
    print(f"Successfully generated 20 unique users in 'unique_sim_users.csv'")
